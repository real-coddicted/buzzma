...
public class AuthServiceImpl implements AuthService {
    ...
    @Override
    @Transactional
    public BuzzmaUser register(final BuzzmaUser user, final UserBankingDetails userBankingDetails, final SecurityAnswer securityAnswer, final Invite invite, final UUID requesterId) {
        ...
        if (canRegister(user, userBankingDetails, securityAnswer, invite, requesterId)) {
            ...
            final String hashedAnswer = passwordService.hashPassword(securityAnswer.getAnswerHash());
    ...
    private boolean canRegister(final BuzzmaUser user, final UserBankingDetails userBankingDetails, final SecurityAnswer securityAnswer, final Invite invite, final UUID requesterId) {
    ...
    private boolean verifyUserBankingDetails(final BuzzmaUser user, final UserBankingDetails userBankingDetails) {
        if (user.getRole() == UserRole.ROLE_BUYER) {
