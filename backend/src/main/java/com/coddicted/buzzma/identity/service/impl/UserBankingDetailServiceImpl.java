...
@Service
public class UserBankingDetailServiceImpl extends BaseCrudService implements UserBankingDetailService {

    private final UserBankingDetailRepository userBankingDetailRepository;

    public UserBankingDetailServiceImpl(final UserBankingDetailRepository userBankingDetailRepository) {
        this.userBankingDetailRepository = userBankingDetailRepository;
    }

    @Override
    public UserBankingDetail create( final UserBankingDetail userBankingDetail, final UUID requesterId) {
        return userBankingDetailRepository.save(
                userBankingDetail.toBuilder()
