...
public class DealController {
  ...
  @GetMapping
  public List<DealResponseDto> list(
  ...
  @GetMapping("/{id}")
  public DealResponseDto getById(@PathVariable UUID id) {
    return service.getById(id);
  }

  @PostMapping
  @ResponseStatus(HttpStatus.CREATED)
  public DealResponseDto create(@Valid @RequestBody DealRequestDto request) {
    return service.create(request);
  }

  @PatchMapping("/{id}")
  public DealResponseDto update(
      @PathVariable UUID id, @Valid @RequestBody DealRequestDto request) {
