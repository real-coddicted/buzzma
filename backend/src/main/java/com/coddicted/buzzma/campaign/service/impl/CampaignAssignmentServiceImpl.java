...
public class CampaignAssignmentServiceImpl extends BaseCrudService
    ...
    public CampaignAssignmentServiceImpl(
    ...
    @Override
    public List<CampaignAssignment> listAssignmentsByAssignee(final UUID assigneeId, final CampaignAssignmentStatus campaignAssignmentStatus) {
        return this.campaignAssignmentRepository.findByAssigneeIdAndStatus(assigneeId, campaignAssignmentStatus);
    }
