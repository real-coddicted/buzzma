...
-- Namespace matches ConfigProvider's NAMESPACE ("backend"); environment matches
-- backend's config-sdk.environment default (CONFIG_SDK_ENVIRONMENT:dev).
...
VALUES
    ('backend', 'dev', 'claim-decision-notification.approved.title',
    ...
    ('backend', 'dev', 'claim-decision-notification.approved.message',
    ...
    ('backend', 'dev', 'claim-decision-notification.rejected.title',
    ...
    ('backend', 'dev', 'claim-decision-notification.rejected.message',
