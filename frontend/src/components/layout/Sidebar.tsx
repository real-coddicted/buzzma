  ...
  return (
    <>
      ...
      >
        <button
          onClick={onClose}
          className="md:hidden absolute top-[calc(0.75rem_+_var(--safe-top))] right-3 w-8 h-8 flex items-center justify-center rounded-lg text-ink-light-secondary dark:text-ink-dark-secondary hover:bg-surface-light-hover dark:hover:bg-surface-dark-hover"
          aria-label="Close menu"
        >
          <IconX size={18} />
        </button>
      <div className="flex-1 overflow-y-auto px-3 pt-[calc(1.25rem_+_var(--safe-top))] pb-4 flex flex-col">
        <Logo />
      ...
      <div className="px-4 pt-3 pb-[calc(0.75rem_+_var(--safe-bottom))] border-t border-surface-light-border dark:border-surface-dark-border">
