    ...
    <div className="space-y-4">
      ...
      <div className="space-y-4">
        <div>
          ...
          <RupeeInput value={form.originalPriceRupees} onChange={v => set('originalPriceRupees', v)} className={inputClass} />
        ...
        <div>
          ...
          <RupeeInput value={form.campaignPriceRupees} onChange={v => set('campaignPriceRupees', v)} className={inputClass} />
