...
export async function createCampaign(dto: CampaignRequestDto): Promise<CampaignResponseDto> {
  ...
  const body: BackendRequest = {
    ...
    ...(dto.additionalRewardType ? { additionalRewardType: dto.additionalRewardType } : {}),
    ...(dto.additionalRewardCashbackPaise != null ? { additionalRewardCashbackPaise: dto.additionalRewardCashbackPaise } : {}),
