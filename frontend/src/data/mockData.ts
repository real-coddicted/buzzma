...
export const campaigns: Campaign[] = [
  ...
  },
  {
    ...
    returnWindowDays: 60,
    campaignType: 'CAMPAIGN_TYPE_AGENCY_DISCRETION',
    totalSlots: 180,
...
export const orderReviews: OrderReviewItem[] = [
  { id: 'or-1',  campaignName: 'Summer Sale Blast',       orderId: 'ORD-10021', orderDate: '2025-04-01', mediatorName: 'Apex Media',        orderStatus: 'delivered',   reviewStatus: 'pending',   approvalMethod: 'manual', mediatorVerified: true,  matchPct: 92 },
  { id: 'or-2',  campaignName: 'Spring Fashion Launch',   orderId: 'ORD-10022', orderDate: '2025-04-03', mediatorName: 'Nova Retail',        orderStatus: 'processing',  reviewStatus: 'in-review', approvalMethod: 'auto',   mediatorVerified: true,  matchPct: 78 },
  { id: 'or-3',  campaignName: 'Health Wellness Q2',      orderId: 'ORD-10023', orderDate: '2025-04-05', mediatorName: 'GreenLeaf Co.',      orderStatus: 'shipped',     reviewStatus: 'approved',  approvalMethod: 'auto',   mediatorVerified: false, matchPct: 55 },
  { id: 'or-4',  campaignName: 'Tech Gadgets Promo',      orderId: 'ORD-10024', orderDate: '2025-04-07', mediatorName: 'Luminary Agency',    orderStatus: 'delivered',   reviewStatus: 'rejected',  approvalMethod: 'manual', mediatorVerified: false, matchPct: 31 },
  { id: 'or-5',  campaignName: 'Beauty Essentials Drop',  orderId: 'ORD-10025', orderDate: '2025-04-09', mediatorName: 'Beacon Digital',     orderStatus: 'pending',     reviewStatus: 'pending',   approvalMethod: 'manual', mediatorVerified: true,  matchPct: 67 },
  { id: 'or-6',  campaignName: 'Summer Sale Blast',       orderId: 'ORD-10026', orderDate: '2025-04-10', mediatorName: 'Orbit Electronics',  orderStatus: 'delivered',   reviewStatus: 'approved',  approvalMethod: 'auto',   mediatorVerified: false, matchPct: 88 },
  { id: 'or-7',  campaignName: 'Fitness Gear Campaign',   orderId: 'ORD-10027', orderDate: '2025-04-12', mediatorName: 'Stride Sports',      orderStatus: 'cancelled',   reviewStatus: 'rejected',  approvalMethod: 'manual', mediatorVerified: true,  matchPct: 19 },
  { id: 'or-8',  campaignName: 'Home Decor Showcase',     orderId: 'ORD-10028', orderDate: '2025-04-14', mediatorName: 'Apex Media',         orderStatus: 'shipped',     reviewStatus: 'in-review', approvalMethod: 'auto',   mediatorVerified: true,  matchPct: 74 },
  { id: 'or-9',  campaignName: 'Spring Fashion Launch',   orderId: 'ORD-10029', orderDate: '2025-04-16', mediatorName: 'Nova Retail',        orderStatus: 'delivered',   reviewStatus: 'approved',  approvalMethod: 'manual', mediatorVerified: false, matchPct: 96 },
  { id: 'or-10', campaignName: 'Tech Gadgets Promo',      orderId: 'ORD-10030', orderDate: '2025-04-18', mediatorName: 'Beacon Digital',     orderStatus: 'processing',  reviewStatus: 'pending',   approvalMethod: 'auto',   mediatorVerified: true,  matchPct: 43 },
  { id: 'or-11', campaignName: 'Beauty Essentials Drop',  orderId: 'ORD-10031', orderDate: '2025-04-20', mediatorName: 'GreenLeaf Co.',      orderStatus: 'delivered',   reviewStatus: 'in-review', approvalMethod: 'manual', mediatorVerified: false, matchPct: 61 },
  { id: 'or-12', campaignName: 'Health Wellness Q2',      orderId: 'ORD-10032', orderDate: '2025-04-22', mediatorName: 'Luminary Agency',    orderStatus: 'pending',     reviewStatus: 'pending',   approvalMethod: 'auto',   mediatorVerified: true,  matchPct: 85 },
]
